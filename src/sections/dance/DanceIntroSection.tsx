...
export default function DanceIntroSection() {
  const { t, img, config, cp } = useHayc();
  const intro = config.dancePageConfig.intro;
          ...
          <div className="col-lg-12">
            <div className="banner-content pt-5 text-center">
              <div className="d-flex align-items-center justify-content-center mb-4">
                <h1 className="text-white fontSize" {...cp('dancePageConfig.intro.headline')}>
                  {t(intro.headline)}
                </h1>
              </div>
              <p className="text-white" {...cp('dancePageConfig.intro.subline')}>
                {t(intro.subline)}
              </p>
              <a
                className="btn btn-primary btn-small text-uppercase mt-3 btn-pill"
                href={intro.ctaHref}
                {...cp('dancePageConfig.intro.ctaLabel')}
              >
                {t(intro.ctaLabel)}
              </a>
            </div>
