...
export default function SelfAwarenessIntroSection() {
  const { t, img, config, cp } = useHayc();
  const intro = config.selfAwarenessPageConfig.intro;
            ...
            <div className="banner-content pt-5 text-center">
              <div className="d-flex align-items-center justify-content-center mb-4">
                <h1
                  ...
                  {...cp('selfAwarenessPageConfig.intro.headline')}
                >
                  {t(intro.headline)}
                </h1>
              </div>
              <p
                ...
                {...cp('selfAwarenessPageConfig.intro.subline')}
              >
                {t(intro.subline)}
              </p>
              <a
                ...
                {...cp('selfAwarenessPageConfig.intro.ctaLabel')}
              >
                {t(intro.ctaLabel)}
              </a>
            </div>
